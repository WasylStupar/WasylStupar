...
function addimg(url){
const previousImage = document.getElementById('my-image');
if (previousImage) {
previousImage.parentNode.removeChild(previousImage);
}

// Створюємо нове зображення і додаємо його до тіла сторінки
const imgElement = document.createElement('img');
imgElement.src = url;
imgElement.id = 'my-image'; // Додавання ідентифікатора
